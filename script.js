...
chooseExpenses();                                                                                                                                     // Вызываем нашу функцию на вопросы по доп. расходам
...
function detectDayBudget () {                                                                                                                         // Создаем функцию по рассчету дневного бюджета
...
function detectLevel () {                                                                                                                             // Оформляем блок кода с уровнем достутка в отдельную функцию
...
function checkSavings () {                                                                                                                            // Пишем функцию для рассчета наших накоплений
...
checkSavings();                                                                                                                                       // Вызываем нашу функцию

function chooseOptExpenses () {                                                                                                                       // Создаем функцию для определения необязательных расходов (chooseOptExpenses)
